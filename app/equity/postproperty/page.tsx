            ...
            <div className="flex justify-center gap-4">
              {!isKYCCompleted ? (
                <Button
                  ...
                  className="bg-gradient-to-r from-[#a78bfa] to-[#9333ea] hover:from-[#9333ea] hover:to-[#a78bfa] text-white px-8 py-6 text-lg rounded-full flex items-center gap-2"
                >
                  <Shield className="w-5 h-5" />
                  Complete KYC First
                </Button>
              ) : (
                <div className="flex items-center gap-2 bg-[#14141F]/80 backdrop-blur-xl border border-[#a78bfa]/20 rounded-full px-6 py-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className={`${stat.color} rounded-2xl p-6 backdrop-blur-sm border border-[#a78bfa]/20`}
              >
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-[#14141F] to-black rounded-xl p-6 text-center h-full border border-[#a78bfa]/20">
                    ...
                    <div className="flex justify-center">
                      <Button
                        variant="outline"
                        className="border-[#a78bfa]/50 text-[#a78bfa] hover:bg-[#a78bfa]/10"
                      >
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="bg-gradient-to-r from-[#a78bfa] to-[#9333ea] rounded-2xl p-8 text-center"
          >
            ...
            <Button
              ...
              className="bg-white text-[#a78bfa] hover:bg-white/90 px-8 py-6 text-lg"
            >
      ...
      {!isPropertyFormOpen && !isProjectFormOpen && !isUserTypeModalOpen && (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
          ...
          >
            <Button
              onClick={handleOpenForm}
              className="bg-gradient-to-r from-[#a78bfa] to-[#9333ea] hover:from-[#9333ea] hover:to-[#a78bfa] text-white px-8 py-6 rounded-full text-lg font-semibold shadow-lg flex items-center gap-2"
            >
              {isKYCCompleted ? (
                <>
