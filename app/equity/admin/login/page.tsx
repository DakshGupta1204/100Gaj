        ...
        <div className="bg-[#14141F]/80 backdrop-blur-xl border-2 border-[#a78bfa] rounded-3xl p-8 shadow-2xl shadow-[#a78bfa]/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-black/50 border-[#a78bfa]/30 text-white pl-10 placeholder-gray-500"
                  placeholder="admin@100gaj.com"
                  required
                />
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-black/50 border-[#a78bfa]/30 text-white pl-10 pr-10 placeholder-gray-500"
                  placeholder="••••••••"
                  required
                />
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#a78bfa] to-[#9333ea] hover:from-[#9333ea] hover:to-[#a78bfa] text-white py-6"
            >
