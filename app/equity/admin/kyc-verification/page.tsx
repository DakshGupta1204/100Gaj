...
export default function AdminKYCVerificationPage() {
  ...
  const handleVerification = async (submissionId: string, status: "approved" | "rejected") => {
    try {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                kycSubmissions
                  ...
                  .map(submission => (
                    <motion.div
                      ...
                      className={`bg-[#14141F]/80 backdrop-blur-xl border border-[#a78bfa]/20 rounded-xl p-4 cursor-pointer transition-all duration-300 hover:border-[#a78bfa]/50 ${
                        selectedSubmission?.id === submission.id ? "border-[#a78bfa]" : ""
                      }`}
            ...
            <div className="lg:col-span-2">
              {selectedSubmission ? (
                <div className="bg-[#14141F]/80 backdrop-blur-xl border-2 border-[#a78bfa] rounded-xl p-6">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="flex gap-2">
                      <Button
                        onClick={() => handleVerification(selectedSubmission.id, "approved")}
                ...
                <div className="bg-[#14141F]/80 backdrop-blur-xl border border-[#a78bfa]/20 rounded-xl p-8 text-center">
