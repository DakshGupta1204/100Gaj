              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    onClick={item.href === "/equity/postproperty" ? handlePostPropertyClick : undefined}
              ...
              {isAuthenticated && (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 text-gray-300 hover:text-white hover:bg-[#a78bfa]/20 hover:border hover:border-[#a78bfa]/30"
                  >
                  ...
                  {/* Dropdown Menu */}
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-black/95 backdrop-blur-sm border border-[#a78bfa]/30 rounded-lg shadow-lg py-1 z-50">
                      <button
                        onClick={() => {
                          setShowUserMenu(false);
