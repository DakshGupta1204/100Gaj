...
var mongodb_1 = require("../app/lib/mongodb");
var User_1 = require("../app/equity/models/User");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, User_1.default.findOne({ email: "admin@100gaj.com" })];
                case 2:
                    ...
                    return [4 /*yield*/, bcrypt.hash("Admin@100gaj", 10)];
                case 3:
