...
export const EMICalculator = () => {
    ...
    return (<div className="bg-gradient-to-br from-orange-500 to-black rounded-xl shadow-xl overflow-hidden shadow-sm shadow-orange-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div>
              ...
              <input type="range" min="100000" max="10000000" step="100000" value={loanAmount} onChange={(_e) => setLoanAmount(Number(_e.target.value))} className="w-full h-2 bg-white rounded-lg appearance-none cursor-pointer accent-orange-400"/>
            ...
            <div>
              ...
              <input type="range" min="5" max="20" step="0.1" value={interestRate} onChange={(_e) => setInterestRate(Number(_e.target.value))} className="w-full h-2 bg-white rounded-lg appearance-none cursor-pointer accent-orange-400"/>
              <div className="flex justify-between mt-1">
            ...
            <div>
              ...
              <input type="range" min="1" max="30" step="1" value={loanTenure} onChange={(_e) => setLoanTenure(Number(_e.target.value))} className="w-full h-2 bg-white rounded-lg appearance-none cursor-pointer accent-orange-400"/>
              <div className="flex justify-between mt-1">
          ...
          <div className="bg-white/10 rounded-xl p-6 border border-orange-500/10">
            ...
            <div className="mt-6">
              <div className="h-4 w-full rounded-full overflow-hidden bg-orange-500/10">
                <div className="h-full bg-gradient-to-r from-orange-400 to-orange-500" style={{ width: `${principalPercentage}%` }}/>
              </div>
