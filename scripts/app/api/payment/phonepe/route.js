...
export async function GET(req) {
    try {
        ...
        await Payment.findOneAndUpdate({ transactionId: merchantTransactionId }, {
            status,
        ...
        return NextResponse.json({ error: 'Failed to process payment callback', details: error.message }, { status: 500 });
    }
}
