    ...
    try {
        ...
        if (typeof data.unitTypes === 'string') {
            ...
            try {
                ...
                return NextResponse.json({ error: 'Invalid unitTypes format' }, { status: 400 });
            }
        }
        ...
        const projectData = Object.assign(Object.assign({}, data), { developer: userId, status: 'pending', verified: false, views: 0, favorites: 0, inquiries: 0 });
