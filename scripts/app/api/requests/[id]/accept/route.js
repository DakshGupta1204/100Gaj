...
export async function POST(req, context) {
    try {
        ...
        console.log('Token decoded for user:', decodedUser === null || decodedUser === void 0 ? void 0 : decodedUser.userId);
        ...
        if (verificationRequest.type === 'agent') {
            ...
            if (verificationRequest.requestDetails) {
                user.agentInfo = Object.assign(Object.assign({}, user.agentInfo), { verified: true, licenseNumber: verificationRequest.requestDetails.licenseNumber, agency: verificationRequest.requestDetails.agency, experience: verificationRequest.requestDetails.experience, specializations: verificationRequest.requestDetails.specializations, languages: verificationRequest.requestDetails.languages });
        ...
        return NextResponse.json({ message: 'Verification request approved successfully', request: verificationRequest }, { status: 200 });
    }
    catch (error) {
        ...
        return NextResponse.json({ error: 'Failed to accept verification request' }, { status: 500 });
    }
}
