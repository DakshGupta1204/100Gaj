...
export async function GET(req) {
    try {
        ...
        const portfolio = await Portfolio.findOne({ userId })
            .populate("holdings.propertyId", "title address propertyType currentPrice")
            .lean();
        if (!portfolio) {
            return NextResponse.json({
                success: false,
        ...
        const summary = Object.assign(Object.assign({}, portfolio.summary), { totalReturnPercentage: portfolio.summary.totalInvested > 0
        ...
        return NextResponse.json({
            ...
            data: Object.assign(Object.assign({}, portfolio), { summary }),
        }, { status: 200 });
    }
    catch (error) {
