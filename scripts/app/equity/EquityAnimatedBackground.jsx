...
export default function EquityAnimatedBackground() {
    return (<div className="fixed inset-0 -z-10 w-full h-full overflow-hidden pointer-events-none">
      <svg width="100%" height="100%" viewBox="0 0 1920 1080" fill="none" className="absolute inset-0 w-full h-full">
        ...
        <path>
          <animate attributeName="d" dur="8s" repeatCount="indefinite" values="M0,600 Q480,500 960,600 T1920,600;M0,620 Q480,700 960,620 T1920,620;M0,600 Q480,500 960,600 T1920,600"/>
        </path>
        <path d="M0,700 Q480,800 960,700 T1920,700" stroke="#a78bfa" strokeWidth="3" fill="none" opacity="0.15">
          <animate attributeName="d" dur="10s" repeatCount="indefinite" values="M0,700 Q480,800 960,700 T1920,700;M0,720 Q480,600 960,720 T1920,720;M0,700 Q480,800 960,700 T1920,700"/>
        </path>
        <path d="M0,800 Q480,900 960,800 T1920,800" stroke="#60a5fa" strokeWidth="2" fill="none" opacity="0.12">
          <animate attributeName="d" dur="12s" repeatCount="indefinite" values="M0,800 Q480,900 960,800 T1920,800;M0,820 Q480,700 960,820 T1920,820;M0,800 Q480,900 960,800 T1920,800"/>
        </path>
        ...
        <path d="M0,900 Q600,1000 1200,900 T1920,900" stroke="#a78bfa" strokeWidth="1.5" fill="none" opacity="0.09">
          <animate attributeName="d" dur="14s" repeatCount="indefinite" values="M0,900 Q600,1000 1200,900 T1920,900;M0,920 Q600,800 1200,920 T1920,920;M0,900 Q600,1000 1200,900 T1920,900"/>
        </path>
        <path d="M0,500 Q700,400 1400,500 T1920,500" stroke="#60a5fa" strokeWidth="1.5" fill="none" opacity="0.09">
          <animate attributeName="d" dur="16s" repeatCount="indefinite" values="M0,500 Q700,400 1400,500 T1920,500;M0,520 Q700,600 1400,520 T1920,520;M0,500 Q700,400 1400,500 T1920,500"/>
        </path>
