...
export default function PortfolioSummary({ portfolio }) {
    ...
    return (<div className="relative rounded-3xl p-8 mb-8 overflow-hidden group bg-black border border-[#a78bfa]">
      ...
      <div className="relative z-10">
        ...
        <div className="relative flex items-center justify-between mb-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg" style={{ background: '#ede9fe' }}>
          ...
          <div>
            <Link href="/equity/portfolio">
              <Button className="rounded-xl px-6 py-3 font-semibold shadow-md transition-colors duration-300 group bg-[#a78bfa] text-white border-none hover:bg-white hover:text-[#a78bfa] focus:bg-white focus:text-[#a78bfa]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          {stats.map((stat, index) => (<div key={stat.title} className="relative rounded-2xl p-7 border border-[#a78bfa] flex flex-col gap-4 group/stat transition-all duration-300 hover:shadow-[0_0_24px_4px_#a78bfa66] hover:scale-[1.035] focus:shadow-[0_0_24px_4px_#a78bfa66] focus:scale-[1.035] outline-none" style={{ background: 'linear-gradient(135deg, #a78bfa22 0%, #1e293b 100%)' }} tabIndex={0}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {additionalStats.map((stat, index) => (<div key={stat.label} className="relative bg-gradient-to-r from-purple-200/10 to-purple-400/10 rounded-2xl p-6 border border-[#a78bfa] backdrop-blur-sm overflow-hidden shadow-lg">
              {/* Sparkle effect */}
        ...
        <div className="relative bg-gradient-to-r from-gray-800/30 to-gray-900/30 backdrop-blur-md rounded-2xl p-8 border border-white/10 overflow-hidden transition-all duration-300 hover:border-[#a78bfa] hover:shadow-[0_0_32px_4px_#a78bfa55]">
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/equity/dashboard">
                <Button size="sm" className="bg-gradient-to-r from-[#a78bfa] to-[#6d28d9] text-white transition-all duration-300 rounded-xl px-6 py-2 shadow-lg border-none">
                  <Zap className="w-4 h-4 mr-2"/>
                  View Analytics
                </Button>
              </Link>
              <Link href="/equity/property">
                <Button size="sm" variant="outline" className="border-white/20 text-gray-300 bg-transparent hover:bg-white hover:text-[#a78bfa] hover:border-[#a78bfa] transition-all duration-300 backdrop-blur-sm rounded-xl px-6 py-2">
