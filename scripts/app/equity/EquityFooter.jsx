...
export default function EquityFooter() {
    return (<footer className="bg-black text-white relative border-t border-[#a78bfa]/30">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm text-white">
              ...
              <li className="flex items-start group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-1 mr-2 text-[#B6FF3F] group-hover:text-[#a78bfa] transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#B6FF3F] group-hover:text-[#a78bfa] transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 0l8 7 8-7"/>
                </svg>
                 <a href="mailto:info@100gaj.com" className="group-hover:text-[#B6FF3F] transition-all duration-300">
        contact@100gaj.com
      </a>
              </li>
              ...
              <li className="flex items-center group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#B6FF3F] group-hover:text-[#a78bfa] transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.5l.49 2.1a2 2 0 01-.45 1.82L8.1 10.9a11.05 11.05 0 005 5l2.48-1.16a2 2 0 011.82.45l2.1.49a2 2 0 011.5 1.94V19a2 2 0 01-2 2h-.5C9.16 21 3 14.84 3 7.5V7a2 2 0 012-2z"/>
                </svg>
