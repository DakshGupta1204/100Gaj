...
export default function Pricing() {
    ...
    return (<main className="min-h-screen bg-black text-white">
      <Navbar />
      <HeroGeometric badge="Exclusive Membership" title1="Choose Your" title2="Premium Plan"/>
      <PricingUI plans={demoPlans} title="Simple, Transparent Pricing" description="Choose the plan that works for you\nAll plans include access to our platform, lead generation tools, and dedicated support."/>
      {/* Hero Section */}
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
            <pattern id="pattern-circles-2" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse" patternContentUnits="userSpaceOnUse">
              <circle id="pattern-circle-2" cx="10" cy="10" r="1.6257413380501518" fill="#FF6600"></circle>
            </pattern>
            <rect id="rect-2" x="0" y="0" width="100%" height="100%" fill="url(#pattern-circles-2)"></rect>
          </svg>
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="inline-block bg-orange-500/20 px-6 py-3 rounded-full mb-6">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="text-lg text-gray-300 max-w-3xl mx-auto">
              See how our premium plans enhance your real estate experience with
              exclusive features and benefits
            </motion.p>
          </div>

          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} viewport={{ once: true }} className="bg-black/50 backdrop-blur-md rounded-xl shadow-xl overflow-hidden border border-orange-500/20">
            ...
            },
            {
        ...
        ].map((row, index) => (<tr key={index} className={index % 2 === 0 ? "bg-black/20" : "bg-black/10"}>
                      <td className="p-5 text-left font-medium text-white">
                        {row.feature}
                      </td>
                      <td className="p-5 text-center text-gray-300">
                        {row.free === "Not available" ? (<X className="w-5 h-5 text-red-500 mx-auto"/>) : (row.free)}
                      </td>
                ...
                row.premium === "Unlimited access to all properties" ? (<div className="flex justify-center items-center font-medium text-orange-500">
                            <Check className="w-5 h-5 text-green-500 mr-2"/>
                            {row.premium}
                          </div>) : (<div className="font-medium text-orange-500">
                            {row.premium}
                          </div>)}
                      </td>
                    </tr>))}
            ...
            },
            {
                ...
                premium: "Comprehensive analysis with safety scores, investment potential",
            },
            {
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
            <pattern id="pattern-circles" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse" patternContentUnits="userSpaceOnUse">
              <circle id="pattern-circle" cx="10" cy="10" r="1.6257413380501518" fill="#FF6600"></circle>
            </pattern>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
            {
                icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-white">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z"/>
                  </svg>),
                title: "Verified Listings",
                description: "All properties undergo rigorous verification to ensure authenticity and quality.",
            },
            {
                icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-white">
                ...
                description: "Access to our team of experienced real estate professionals.",
            },
            {
                icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-white">
                ...
                description: "Round-the-clock support for all your real estate queries.",
            },
        ].map((feature, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }} className="bg-black/50 backdrop-blur-md rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-orange-500/20 group hover:border-orange-500/40">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="max-w-4xl mx-auto bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-12 shadow-xl relative overflow-hidden border border-orange-500/30">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center">
                <a href="/subscription" className="inline-block px-8 py-4 bg-white text-orange-500 font-semibold rounded-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5">
                  Get Started Today
                </a>
              </div>
            </div>
