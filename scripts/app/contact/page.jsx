...
export default function ContactUs() {
    ...
    const handleSubmit = async (_e) => {
        ...
        try {
            const response = await fetch('/api/contact', {
                ...
                body: JSON.stringify(Object.assign(Object.assign({}, formData), { timestamp: new Date().toISOString(), userAgent: navigator.userAgent })),
            });
    ...
    return (<main className="min-h-screen bg-black text-white">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="w-full md:w-[45%]">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="group relative">
                            ...
                            <div className="relative bg-gradient-to-br from-zinc-900 to-black p-8 rounded-xl shadow-xl border border-orange-500/10 group-hover:border-orange-500/30 transition-all duration-300">
                                {formStatus.type && (<div className={`mb-6 p-4 rounded-md ${formStatus.type === 'success' ? 'bg-green-500/20 text-green-300' : 'bg-red-500/20 text-red-300'}`}>
                                        {formStatus.message}
                                    </div>)}
                                ...
                                <form className="space-y-6" onSubmit={handleSubmit}>
                                    <div>
                                        ...
                                        <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} placeholder="Enter your full name" className={`w-full px-4 py-3 rounded-md bg-black/60 border focus:outline-none focus:ring-2 text-white ${fieldErrors.fullName
            ...
            : 'border-orange-500/20 focus:ring-orange-500/50 focus:border-orange-500/50'}`}/>
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Enter your email address" className={`w-full px-4 py-3 rounded-md bg-black/60 border focus:outline-none focus:ring-2 text-white ${fieldErrors.email
            ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50'
            : 'border-orange-500/20 focus:ring-orange-500/50 focus:border-orange-500/50'}`}/>
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="Enter your phone number" className={`w-full px-4 py-3 rounded-md bg-black/60 border focus:outline-none focus:ring-2 text-white ${fieldErrors.phone
            ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50'
            : 'border-orange-500/20 focus:ring-orange-500/50 focus:border-orange-500/50'}`}/>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="message" value={formData.message} onChange={handleChange} placeholder="Tell us about your inquiry, requirements, or how we can help you..." rows={4} className={`w-full px-4 py-3 rounded-md bg-black/60 border focus:outline-none focus:ring-2 text-white resize-vertical ${fieldErrors.message
            ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50'
            : 'border-orange-500/20 focus:ring-orange-500/50 focus:border-orange-500/50'}`}></textarea>
                                    ...
                                    <div className="text-center">
                                        <button type="submit" disabled={isLoading} className={`px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300 hover:-translate-y-0.5 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}>
        ...
        ].map((testimonial, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }} viewport={{ once: true }} className="group relative">
        ...
        ].map((faq, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }} viewport={{ once: true }} className="group relative">
