...
export default function HousePricePrediction() {
    ...
    const FeatureIcon = ({ icon: Icon, active, }) => (<div className={`p-2 rounded-full ${active ? "bg-orange-500" : "bg-neutral-800"}
      ...
      <div className="max-w-4xl mx-auto my-20 mb-32">
        ...
        <Card className="bg-neutral-900 border-none shadow-lg shadow-orange-500/10">
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 relative group">
                  ...
                  <Input id="area" name="area" type="number" value={formData.area} onChange={handleInputChange} placeholder="Enter area in square feet" required className="bg-neutral-800 border-neutral-700 focus:border-orange-500 focus:ring-orange-500/20 transition-all"/>
                ...
                <div className="space-y-2 relative group">
                  ...
                  <Input id="bedrooms" name="bedrooms" type="number" value={formData.bedrooms} onChange={handleInputChange} placeholder="Number of bedrooms" required className="bg-neutral-800 border-neutral-700 focus:border-orange-500 focus:ring-orange-500/20 transition-all"/>
                </div>
                ...
                <div className="space-y-2 relative group">
                  ...
                  <SearchDropdown name="location" placeholder="Search for a location..." options={locations} value={formData.location} onChangeAction={(value) => handleSelectChange("location", value)} required icon={<MapPin size={14}/>}/>
                </div>
                ...
                <div className="space-y-2 relative group">
                  ...
                  <SearchDropdown name="city" placeholder="Search for a city..." options={cities} value={formData.city} onChangeAction={(value) => handleSelectChange("city", value)} required icon={<Building size={14}/>}/>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-neutral-800">
                ...
                <div className="grid grid-cols-2 gap-4 justify-items-center">
                  {/* Resale */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("resale", formData.resale === "1" ? "0" : "1")}>
                  ...
                  {/* Swimming Pool */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("swimmingpool", formData.swimmingpool === "1" ? "0" : "1")}>
                    <div className="flex flex-col items-center gap-3">
                  ...
                  {/* Car Parking */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("carparking", formData.carparking === "1" ? "0" : "1")}>
                    <div className="flex flex-col items-center gap-3">
                  ...
                  {/* School Nearby */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("school", formData.school === "1" ? "0" : "1")}>
                    <div className="flex flex-col items-center gap-3">
                  ...
                  {/* Lift */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("lift", formData.lift === "1" ? "0" : "1")}>
                    <div className="flex flex-col items-center gap-3">
                  ...
                  {/* Maintenance */}
                  <div className="bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition-all cursor-pointer w-full max-w-xs" onClick={() => handleSelectChange("maintenance", formData.maintenance === "1" ? "0" : "1")}>
                    <div className="flex flex-col items-center gap-3">
              ...
              <Button type="submit" className="w-full py-6 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-all duration-300 shadow-lg shadow-orange-500/20" disabled={loading}>
            ...
            {predictedPrice !== null && (<div className="mt-10 relative">
