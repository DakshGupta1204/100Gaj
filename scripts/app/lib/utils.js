 ...
 */
export function getVerificationEmailTemplate(verificationCode) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
 ...
 */
export function getPasswordResetEmailTemplate(verificationCode) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function generateToken(payload) {
    ...
    }, secret, { expiresIn: '7d' } // Token expires in 7 days
    );
    return token;
}
